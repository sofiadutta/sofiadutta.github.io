;(function () {
	...
	var deobfuscateEmail = function() {
		...
		emailLink.setAttribute('href', 'mailto:' + encodedEmail);
		emailLink.textContent = clearEmail;
