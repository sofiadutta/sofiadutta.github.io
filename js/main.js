		...
		btn.addEventListener('click', function(e) {
			...
			if (navigator.clipboard && window.isSecureContext) {
				navigator.clipboard.writeText(cleartext).then(function() {
					...
					setTimeout(function() {
						btn.innerHTML = '<i class="icon-clipboard" aria-hidden="true"></i> Copy';
