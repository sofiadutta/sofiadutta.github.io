;(function () {
	...
	var initCopyEmail = function() {
		...
		btn.addEventListener('click', function() {
			var email = el.innerText.replace(/DOT/g, '.').replace(/AT/g, '@').replace(/\s/g, '');
			var writeText = (navigator.clipboard && window.isSecureContext)
