;(function () {
	...
	var deobfuscateEmails = function() {
		$('.js-obfuscated-hire').each(function() {
			var $this = $(this);
			var obfuscated = $this.attr('data-email');
			if (obfuscated) {
				var email = obfuscated.replace(/ DOT /g, '.').replace(/ AT /g, '@').replace(/\s+/g, '');
		...
		$('.js-obfuscated-email').each(function() {
			var $this = $(this);
			var text = $this.text();
