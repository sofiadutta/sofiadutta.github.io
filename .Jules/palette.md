...
## 2024-06-01 - [Progressive Enhancement for Obfuscated Emails]
**Learning:** Hardcoding obfuscated emails (e.g., 'DOT' and 'AT') is great for deterring bots but creates terrible UX (unclickable, hard to copy) and accessibility issues for screen readers.
**Action:** Maintain the obfuscation in the static HTML, but use client-side JavaScript to dynamically parse the text, reconstruct a clean `mailto:` link, and add a 'Copy to clipboard' button for convenience.
