...
## 2024-07-08 - Copy Buttons for Obfuscated Text
**Learning:** Replacing deliberately obfuscated text (like emails with "AT" and "DOT") with hardcoded cleartext links defeats the anti-spam purpose.
**Action:** Maintain obfuscated text in HTML, but use JavaScript to dynamically reconstruct the email and copy it to the clipboard, pairing it with an accessible, interactive "Copy" button.
