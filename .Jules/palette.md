...
## 2026-03-27 - [Clipboard UX for Obfuscated Data]
**Learning:** When adding 'copy to clipboard' functionality for obfuscated data (like anti-spam emails), storing the raw string in a `data-*` attribute defeats the obfuscation.
**Action:** Instead, read the obfuscated text dynamically from the DOM and de-obfuscate it client-side inside the event listener.
