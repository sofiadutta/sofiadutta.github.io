...
## 2025-02-20 - Iframe Sandbox Security Enhancement
**Vulnerability:** Third-party iframe embeds without sandbox attributes.
**Learning:** Third-party iframe elements (like YouTube embeds) can potentially pose cross-site scripting (XSS) breakout risks. Applying restrictive sandbox attributes limits their capabilities and enhances security.
