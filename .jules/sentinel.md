...
## 2024-05-24 - Email Harvesting Vulnerability
**Vulnerability:** Hardcoded email address in `mailto:` link in `index.html`.
**Learning:** Hardcoded email addresses are easily scraped by bots and spammers, leading to unsolicited emails and potential phishing attacks.
**Prevention:** Use data attributes (`data-user` and `data-domain`) and JavaScript to dynamically construct the `mailto:` URL upon user interaction (click), preventing automated harvesting.
