...
## 2025-02-19 - Add Sandbox Attribute to Third-Party Iframes
**Vulnerability:** Third-party iframe embeds without sandbox attributes.
**Learning:** External content embedded via iframe without a sandbox attribute can potentially break out of their containment or execute malicious code within the parent context.
**Prevention:** Always include the `sandbox="allow-scripts allow-same-origin allow-presentation allow-popups"` attribute on `iframe` tags to enforce strict containment.
