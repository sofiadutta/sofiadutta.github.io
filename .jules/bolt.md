...
## 2025-01-08 - Conditional Preloading for Mobile Performance
**Learning:** Unconditionally preloading large sidebar assets (e.g., 2.9MB `images/about.jpg`) hurts mobile performance where the sidebar is hidden.
**Action:** Use `media="(min-width: 769px)"` on `<link rel="preload">` tags for assets that are only immediately visible on desktop viewports.
