...
## 2024-07-17 - Debouncing UX-critical events
**Learning:** When debouncing events that trigger visual state changes (like closing menus on scroll), trailing-edge debounce causes noticeable UX lag.
**Action:** Always configure debounce for immediate execution (leading edge) on visual UI toggles.
