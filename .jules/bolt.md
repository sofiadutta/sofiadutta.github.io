...
## 2026-03-29 - Scroll Event Thrashing
**Learning:** The template's offcanvas menu system implements an unthrottled global scroll event handler, causing main thread blocking during heavy scrolling.
**Action:** Use window.requestAnimationFrame coupled with a 'ticking' boolean flag over debounce to ensure instant UX feedback without blocking the main thread during heavy scrolling.
