...
## 2025-01-08 - Throttling Scroll Events with requestAnimationFrame
**Learning:** Scroll events in js/main.js were executing synchronous DOM queries ($('body').hasClass('offcanvas')) on every event emission, causing potential frame drops and layout thrashing.
**Action:** Always throttle high-frequency events like scroll or resize. Using requestAnimationFrame is highly effective for scroll events as it perfectly aligns the callback with the browser's rendering cycle.
